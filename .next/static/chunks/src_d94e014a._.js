...
"[project]/src/components/dashboard/admin-dashboard.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function AdminDashboard() {
    _s();
    const { complaints, invoices, loading: complaintsLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$ComplaintContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useComplaint"])();
    const { technicians, loading: techniciansLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$EmployeeContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEmployee"])();
    const { user, role, setViewAsRole, viewAsRole } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AuthProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const dashboardStats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminDashboard.useMemo[dashboardStats]": ()=>{
            ...
            const vehiclesInWorkshop = complaints.filter({
                "AdminDashboard.useMemo[dashboardStats]": (c)=>c.status !== 'Closed' && c.status !== 'Resolved'
            }["AdminDashboard.useMemo[dashboardStats]"]).length;
            const openRepairOrders = complaints.filter({
                "AdminDashboard.useMemo[dashboardStats]": (c)=>c.status === 'Open'
            }["AdminDashboard.useMemo[dashboardStats]"]).length;
            const completedTickets = complaints.filter({
                "AdminDashboard.useMemo[dashboardStats].completedTickets": (c)=>(c.status === 'Closed' || c.status === 'Resolved') && c.resolvedAt
            }["AdminDashboard.useMemo[dashboardStats].completedTickets"]);
            const totalRepairHours = completedTickets.reduce({
                "AdminDashboard.useMemo[dashboardStats].totalRepairHours": (acc, c)=>{
                    if (!c.resolvedAt) return acc;
                    const created = new Date(c.createdAt);
                    const resolved = new Date(c.resolvedAt);
                    return acc + (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$differenceInHours$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["differenceInHours"])(resolved, created);
                }
            }["AdminDashboard.useMemo[dashboardStats].totalRepairHours"], 0);
            ...
            // For charts
            const statusDistribution = complaints.reduce({
                "AdminDashboard.useMemo[dashboardStats].statusDistribution": (acc, c)=>{
                    if ([
                        'In Progress',
                        'Technician Assigned',
                        'Estimate Approved'
            ...
            }["AdminDashboard.useMemo[dashboardStats].statusDistribution"], {
                inService: 0,
                awaitingService: 0,
                completed: 0
            });
            const repairTimeByMonth = completedTickets.reduce({
                "AdminDashboard.useMemo[dashboardStats].repairTimeByMonth": (acc, c)=>{
                    if (!c.resolvedAt) return acc;
                    const month = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(c.resolvedAt), 'MMM');
                    const hours = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$differenceInHours$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["differenceInHours"])(new Date(c.resolvedAt), new Date(c.createdAt));
                    if (!acc[month]) {
                        acc[month] = {
                            totalHours: 0,
                            count: 0
            ...
            }["AdminDashboard.useMemo[dashboardStats].repairTimeByMonth"], {});
            const repairTimeTrend = Object.keys(repairTimeByMonth).map({
                "AdminDashboard.useMemo[dashboardStats].repairTimeTrend": (month)=>({
                        month,
                        averageHours: repairTimeByMonth[month].totalHours / repairTimeByMonth[month].count
                    })
            }["AdminDashboard.useMemo[dashboardStats].repairTimeTrend"]).slice(-6); // Last 6 months
            return {
                vehiclesInWorkshop,
                openRepairOrders,
                avgRepairTime,
                ...
                statusDistribution: Object.entries(statusDistribution).map({
                    "AdminDashboard.useMemo[dashboardStats]": ([name, value])=>({
                            name,
                            value,
                            fill: `var(--color-${name})`
                        })
    ...
    const receivablesStats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminDashboard.useMemo[receivablesStats]": ()=>{
            if (!clientReady) return {
                totalOutstanding: 0,
                dueToday: 0,
                dueWithin30Days: 0,
            ...
            const thirtyDaysFromNow = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$addDays$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDays"])(today, 30);
            const unpaidInvoices = invoices.filter({
                "AdminDashboard.useMemo[receivablesStats].unpaidInvoices": (inv)=>inv.status === 'Unpaid'
            }["AdminDashboard.useMemo[receivablesStats].unpaidInvoices"]);
            const paidInvoices = invoices.filter({
                "AdminDashboard.useMemo[receivablesStats].paidInvoices": (inv)=>inv.status === 'Paid'
            }["AdminDashboard.useMemo[receivablesStats].paidInvoices"]);
            const totalOutstanding = unpaidInvoices.reduce({
                "AdminDashboard.useMemo[receivablesStats].totalOutstanding": (sum, inv)=>sum + inv.total
            }["AdminDashboard.useMemo[receivablesStats].totalOutstanding"], 0);
            const overdueInvoices = unpaidInvoices.filter({
                "AdminDashboard.useMemo[receivablesStats].overdueInvoices": (inv)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isAfter$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isAfter"])(today, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$addDays$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDays"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfDay$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startOfDay"])(new Date(inv.date)), 30))
            }["AdminDashboard.useMemo[receivablesStats].overdueInvoices"]);
            const totalOverdue = overdueInvoices.reduce({
                "AdminDashboard.useMemo[receivablesStats].totalOverdue": (sum, inv)=>sum + inv.total
            }["AdminDashboard.useMemo[receivablesStats].totalOverdue"], 0);
            const dueToday = unpaidInvoices.filter({
                "AdminDashboard.useMemo[receivablesStats].dueToday": (inv)=>{
                    const dueDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$addDays$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDays"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfDay$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startOfDay"])(new Date(inv.date)), 30);
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isToday$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isToday"])(dueDate);
                }
            }["AdminDashboard.useMemo[receivablesStats].dueToday"]).reduce({
                "AdminDashboard.useMemo[receivablesStats].dueToday": (sum, inv)=>sum + inv.total
            }["AdminDashboard.useMemo[receivablesStats].dueToday"], 0);
            const dueWithin30Days = unpaidInvoices.filter({
                "AdminDashboard.useMemo[receivablesStats].dueWithin30Days": (inv)=>{
                    const dueDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$addDays$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDays"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfDay$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startOfDay"])(new Date(inv.date)), 30);
                    return !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isAfter$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isAfter"])(dueDate, thirtyDaysFromNow) && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isAfter$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isAfter"])(dueDate, today);
                }
            }["AdminDashboard.useMemo[receivablesStats].dueWithin30Days"]).reduce({
                "AdminDashboard.useMemo[receivablesStats].dueWithin30Days": (sum, inv)=>sum + inv.total
            }["AdminDashboard.useMemo[receivablesStats].dueWithin30Days"], 0);
            const totalPaymentDays = paidInvoices.reduce({
                "AdminDashboard.useMemo[receivablesStats].totalPaymentDays": (acc, inv)=>{
                    const complaint = complaints.find({
                        "AdminDashboard.useMemo[receivablesStats].totalPaymentDays.complaint": (c)=>c.id === inv.ticketId
                    }["AdminDashboard.useMemo[receivablesStats].totalPaymentDays.complaint"]);
                    ...
                    return acc + (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$differenceInDays$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["differenceInDays"])(paymentDate, invoiceDate);
                }
            }["AdminDashboard.useMemo[receivablesStats].totalPaymentDays"], 0);
    ...
    if (loading || !clientReady) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {
                ...
                fileName: "[project]/src/components/dashboard/admin-dashboard.tsx",
                lineNumber: 161,
                columnNumber: 13
            }, this)
        }, void 0, false, {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$shared$2f$page$2d$header$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PageHeader"], {
                ...
                children: role === 'admin' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "flex items-center gap-2",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                            variant: viewAsRole === 'technician' ? 'default' : 'outline',
                            onClick: ()=>setViewAsRole(viewAsRole === 'technician' ? null : 'technician'),
                            children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                            variant: viewAsRole === 'customer' ? 'default' : 'outline',
                            onClick: ()=>setViewAsRole(viewAsRole === 'customer' ? null : 'customer'),
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$eye$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Eye$3e$__["Eye"], {
                                    className: "mr-2"
                                }, void 0, false, {
                        ...
                        viewAsRole && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                            variant: "ghost",
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: dashboardStats.vehiclesInWorkshop
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/dashboard/admin-dashboard.tsx",
                                                        lineNumber: 199,
                                                        columnNumber: 33
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "text-2xl font-bold",
                                                        children: dashboardStats.openRepairOrders
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/dashboard/admin-dashboard.tsx",
                                                        lineNumber: 211,
                                                        columnNumber: 33
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: "text-xs text-muted-foreground",
                                                    children: "For all closed tickets"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/components/dashboard/admin-dashboard.tsx",
                                                    lineNumber: 223,
                                                    columnNumber: 29
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardTitle"], {
                                                        className: "text-sm font-medium",
                                                        children: "Available Technicians"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/dashboard/admin-dashboard.tsx",
                                                        lineNumber: 229,
                                                        columnNumber: 33
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "text-2xl font-bold",
                                                        children: dashboardStats.availableTechnicians
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/dashboard/admin-dashboard.tsx",
                                                        lineNumber: 233,
                                                        columnNumber: 33
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: "font-code",
                                                            children: receivablesStats.totalOutstanding.toLocaleString()
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/components/dashboard/admin-dashboard.tsx",
                                                            lineNumber: 248,
                                                            columnNumber: 100
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: "text-xs text-muted-foreground",
                                                    children: "Across all unpaid invoices"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/components/dashboard/admin-dashboard.tsx",
                                                    lineNumber: 249,
                                                    columnNumber: 29
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: "font-code",
                                                            children: receivablesStats.totalOverdue.toLocaleString()
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/components/dashboard/admin-dashboard.tsx",
                                                            lineNumber: 258,
                                                            columnNumber: 100
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: "text-xs text-muted-foreground",
                                                    children: "Past due by over 30 days"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/components/dashboard/admin-dashboard.tsx",
                                                    lineNumber: 259,
                                                    columnNumber: 30
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: "font-code",
                                                            children: receivablesStats.dueWithin30Days.toLocaleString()
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/components/dashboard/admin-dashboard.tsx",
                                                            lineNumber: 268,
                                                            columnNumber: 100
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "text-xl font-bold",
                                                    children: [
                                                        receivablesStats.averagePaymentTime,
                                                        " Days"
                                                    ]
                                                }, void 0, true, {
                                                    fileName: "[project]/src/components/dashboard/admin-dashboard.tsx",
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: "text-xs text-muted-foreground",
                                                    children: "From invoice to payment"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/components/dashboard/admin-dashboard.tsx",
                                                    lineNumber: 279,
                                                    columnNumber: 29
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                            children: "Live breakdown of vehicle statuses in the workshop."
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/dashboard/admin-dashboard.tsx",
                                            lineNumber: 291,
                                            columnNumber: 17
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                            children: "Monthly average time (in hours) per repair order."
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/dashboard/admin-dashboard.tsx",
                                            lineNumber: 319,
                                            columnNumber: 17
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$chart$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ChartContainer"], {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$recharts$2f$es6$2f$chart$2f$BarChart$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BarChart"], {
                                            data: dashboardStats.repairTimeTrend,
                                            children: [
...
_s(AdminDashboard, "sTk43Ht6P3lN/SHltkhgnquywUs=", false, function() {
    return [
...
"[project]/src/components/dashboard/technician-dashboard.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function TechnicianDashboard() {
    _s();
    const { user, loading: authLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AuthProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    const { complaints, loading: complaintsLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$ComplaintContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useComplaint"])();
    const loading = authLoading || complaintsLoading;
    const techStats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TechnicianDashboard.useMemo[techStats]": ()=>{
            if (!user) return {
                openTickets: 0,
                avgResolutionTime: '0',
                resolvedThisMonth: 0,
            ...
            const myTickets = complaints.filter({
                "TechnicianDashboard.useMemo[techStats].myTickets": (c)=>c.assignedTo === user.name
            }["TechnicianDashboard.useMemo[techStats].myTickets"]);
            const openTickets = myTickets.filter({
                "TechnicianDashboard.useMemo[techStats]": (c)=>c.status !== 'Resolved' && c.status !== 'Closed'
            }["TechnicianDashboard.useMemo[techStats]"]).length;
            const resolvedTickets = myTickets.filter({
                "TechnicianDashboard.useMemo[techStats].resolvedTickets": (c)=>(c.status === 'Resolved' || c.status === 'Closed') && c.resolvedAt
            }["TechnicianDashboard.useMemo[techStats].resolvedTickets"]);
            const totalRepairHours = resolvedTickets.reduce({
                "TechnicianDashboard.useMemo[techStats].totalRepairHours": (acc, c)=>{
                    if (!c.resolvedAt) return acc;
                    const created = new Date(c.createdAt);
                    const resolved = new Date(c.resolvedAt);
                    return acc + (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$differenceInHours$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["differenceInHours"])(resolved, created);
                }
            }["TechnicianDashboard.useMemo[techStats].totalRepairHours"], 0);
            const avgResolutionTime = resolvedTickets.length > 0 ? (totalRepairHours / resolvedTickets.length).toFixed(1) : "0";
            const oneMonthAgo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$subDays$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subDays"])(new Date(), 30);
            const resolvedThisMonth = resolvedTickets.filter({
                "TechnicianDashboard.useMemo[techStats]": (c)=>c.resolvedAt && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isAfter$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isAfter"])(new Date(c.resolvedAt), oneMonthAgo)
            }["TechnicianDashboard.useMemo[techStats]"]).length;
    ...
    if (loading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {
                ...
                fileName: "[project]/src/components/dashboard/technician-dashboard.tsx",
                lineNumber: 54,
                columnNumber: 17
            }, this)
        }, void 0, false, {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "text-2xl font-bold",
                                        children: techStats.openTickets
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/dashboard/technician-dashboard.tsx",
                                        lineNumber: 72,
                                        columnNumber: 25
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-xs text-muted-foreground",
                                        children: "Tickets assigned to you that are active."
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/dashboard/technician-dashboard.tsx",
                                        lineNumber: 73,
                                        columnNumber: 25
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-xs text-muted-foreground",
                                        children: "Your average time to resolve tickets."
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/dashboard/technician-dashboard.tsx",
                                        lineNumber: 83,
                                        columnNumber: 26
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardTitle"], {
                                        className: "text-sm font-medium",
                                        children: "Resolved (Last 30 Days)"
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/dashboard/technician-dashboard.tsx",
                                        lineNumber: 88,
                                        columnNumber: 25
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "text-2xl font-bold",
                                        children: techStats.resolvedThisMonth
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/dashboard/technician-dashboard.tsx",
                                        lineNumber: 92,
                                        columnNumber: 25
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-xs text-muted-foreground",
                                        children: "Tickets you've resolved this month."
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/dashboard/technician-dashboard.tsx",
                                        lineNumber: 93,
                                        columnNumber: 26
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                children: "Your 5 most recently assigned or updated tickets."
                            }, void 0, false, {
                                fileName: "[project]/src/components/dashboard/technician-dashboard.tsx",
                                lineNumber: 100,
                                columnNumber: 21
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                        children: techStats.recentTickets.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "space-y-4",
                            children: [
                                techStats.recentTickets.map((ticket)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        ...
                                                        children: [
                                                            ...
                                                            " | Submitted: ",
                                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(ticket.createdAt), 'PPP')
                                                        ]
                                                    }, void 0, true, {
                                                        fileName: "[project]/src/components/dashboard/technician-dashboard.tsx",
                                                        lineNumber: 109,
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                children: "You have no assigned tickets yet."
                            }, void 0, false, {
                                fileName: "[project]/src/components/dashboard/technician-dashboard.tsx",
                                lineNumber: 122,
                                columnNumber: 29
...
_s(TechnicianDashboard, "7SkJ0B7ZUVyUhHAmhKenJ/TlizY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AuthProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$ComplaintContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useComplaint"]
    ];
});
_c = TechnicianDashboard;
var _c;
__turbopack_context__.k.register(_c, "TechnicianDashboard");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AuthProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/context/AuthProvider.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/loader-circle.js [app-client] (ecmascript) <export default as Loader2>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$dashboard$2f$admin$2d$dashboard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/dashboard/admin-dashboard.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$dashboard$2f$technician$2d$dashboard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/dashboard/technician-dashboard.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function DashboardPage() {
    _s();
    const { viewAsRole, role, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AuthProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    if (effectiveRole === 'technician') {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$dashboard$2f$technician$2d$dashboard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TechnicianDashboard"], {}, void 0, false, {
            fileName: "[project]/src/app/(app)/dashboard/page.tsx",
            lineNumber: 24,
            columnNumber: 16
        }, this);
    }
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$dashboard$2f$admin$2d$dashboard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AdminDashboard"], {}, void 0, false, {
        fileName: "[project]/src/app/(app)/dashboard/page.tsx",
        lineNumber: 27,
        columnNumber: 12
    }, this);
}
_s(DashboardPage, "KIKmEFX4A//rX1Jb4lqNQMcFbTA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AuthProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
//# sourceMappingURL=src_d94e014a._.js.map